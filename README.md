...
## Description
Thanks to that application you can save series that you are watching or you will be watching.
You can save season,episode,type,animation style and many more
...
### You can add many names to one series. Thanks to that, you can search series in searchbar using other names
...
<code>git pull</code> - downloading newest changes
